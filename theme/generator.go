...
func LoadThemeFromJSON(path string) (*ThemeConfig, error) {
...
func (config *ThemeConfig) ToColorScheme(isDark bool) (ColorScheme, error) {
...
func GenerateThemeConstants(config *ThemeConfig) string {
